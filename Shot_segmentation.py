...
directory = r"C:\Users\91949\Desktop\shots"
os.chdir(directory)

# create videowriter object 
out_mp4 = cv2.VideoWriter('shot1.mp4',cv2.VideoWriter_fourcc('m', 'p', '4', 'v'), 24, (frame_width,frame_height))
...
while i<=10000:
    ...
    imageA = cv2.imread(r"C:\Users\91949\Desktop\frames\Frame"+str(i)+".png")
    imageB = cv2.imread(r"C:\Users\91949\Desktop\frames\Frame"+str(i+1)+".png")
